...
export default function WebOfficialRoomsCreate() {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex flex-col gap-4">
                <Heading title="Tambah Kamar" description="Tambah data kamar inap baru." />
                ...
                <form onSubmit={submit} className="max-w-2xl space-y-5 rounded-xl border bg-card p-6">
                    ...
                    <div className="grid gap-2">
                        <Label htmlFor="photo">URL foto (opsional jika upload file)</Label>
                        <Input
                            id="photo"
                            type="url"
                            value={data.photo}
