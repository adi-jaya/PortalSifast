...
export default function WebOfficialPromosiCreate() {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex flex-col gap-4">
                <Heading title="Tambah Promo" description="Buat promo baru untuk website official." />
                ...
                <form onSubmit={submit} className="max-w-2xl space-y-5 rounded-xl border bg-card p-6">
                    ...
                    <div className="grid gap-2">
                        <Label htmlFor="cover_file">Upload cover</Label>
                        <Input
                            id="cover_file"
                            type="file"
