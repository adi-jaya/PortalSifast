...
export default function AsetImport({ templateUrl, preview }: Props) {
            ...
            <div className="relative mx-auto max-w-3xl space-y-5 px-4 pb-28 pt-2 sm:px-0">
                <header className="mb-2 border-b border-border/70 pb-5">
                    ...
                    <p className="mt-1.5 max-w-xl text-sm leading-relaxed text-muted-foreground">
                        Unduh template → isi (1 baris = 1 unit) → preview → konfirmasi. Katalog wajib kode ASPAK /
                        non-alkes; ruang pakai kode_ruang.
                    </p>
                </header>
                ...
                <section className="rounded-xl border border-border/80 bg-card shadow-[0_1px_2px_rgba(0,0,0,0.04)]">
                    <div className="border-b border-border/60 bg-muted/30 px-5 py-4">
                        ...
                        <p className="mt-0.5 text-sm text-muted-foreground">CSV UTF-8, maksimal 500 baris.</p>
                    </div>
