...
export default function MutuIndicatorsEdit({
    indicator,
    categories,
    departments,
    accountableUsers,
    ...
    const { data, setData, put, processing, errors, transform } = useForm({
        mutu_category_id: String(indicator.mutu_category_id),
        ...
        accountable_user_id: indicator.accountable_user_id
            ? String(indicator.accountable_user_id)
            : '__none__',
        ...
        analysis_period: indicator.analysis_period,
        has_mutu_benchmarking: indicator.has_mutu_benchmarking,
        data_source: indicator.data_source ?? '',
        target_value: indicator.target_value,
        weight_in_category: indicator.weight_in_category,
        dep_ids: indicator.dep_ids,
    });
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex flex-col gap-4">
                ...
                <form
                    onSubmit={(e) => {
                        e.preventDefault();
                        put(`/simmutu/indicators/${indicator.id}`);
                    }}
