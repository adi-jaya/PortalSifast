            ...
            <div className="flex flex-col gap-4">
                <div className="flex items-start gap-3">
                    ...
                    <Heading
                        ...
                        description="Satu project bisa berisi banyak tiket"
                        variant="small"
                    />
                </div>
                ...
                >
                    <div className="grid gap-2">
                        ...
                        <Input
                            ...
                            placeholder="Contoh: Migrasi Server 2025"
                            maxLength={255}
                            required
                        />
                    ...
                    <div className="grid gap-2">
                        ...
                        <textarea
                            ...
                            placeholder="Deskripsi singkat rencana/proyek"
                            rows={3}
                    ...
                    <div className="grid gap-2">
                        ...
                        <Input
                            ...
                            placeholder="Kode departemen jika ada"
                            maxLength={50}
                        />
